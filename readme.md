...
To install, download the latest installer from the [actions](https://github.com/CyberillcButSmarter/Waifu2x-GUI-Intel-Mac/actions) tab. Updates can be installed automatically.
